...
import { WatcherToolTip } from "@/assets/images/role/WatcherToolTip";
        ...
        <CurrentContainer>
          ...
          <AchieveDiv>
            <ProgressBarContainer>
              ...
              <WatcherToolTipWrapper $rate={data.achievementRate}>
                <WatcherToolTip achievementRate={data.achievementRate} />
              </WatcherToolTipWrapper>
            </ProgressBarContainer>
...
const WatcherToolTipWrapper = styled.div<{ $rate: number }>`
  position: absolute;
  top: -44px;
  left: ${({ $rate }) => `${$rate}%`};
